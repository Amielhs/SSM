...
<div class="right">
    ...
    <div class="providerAdd">
        <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/modifysave" enctype="multipart/form-data">
            ...
            <div>
                ...
                <c:choose>
                    <c:when test="${provider.orgCodePicPath == null || provider.orgCodePicPath == ''}">
                        <input type="hidden" id="errorinfo" value="${uploadOcError}"/>
