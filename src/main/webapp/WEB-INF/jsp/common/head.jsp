...
<head lang="en">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/updateTime.js"></script>
</head>
<body>
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span id="updateTime">下午好！</span><span style="color: #fff21b"> ${userSession.userName }</span> , 欢迎你！</p>
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="${pageContext.request.contextPath }/user/modifypwdview">密码修改</a></li>
